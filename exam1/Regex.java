...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("^(?=.*[^aeiou]).{6,}[0-9]$");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("((https?)://)?(?:www.)[a-zA-Z0-9.-][a-zA-Z0-9.-]+[a-zA-Z0-9.-]\.[^\s]{2,}");
        ...
        // Provide regex pattern
        pattern = Pattern
                .compile("[a-zA-Z0-9].*\\.pptx|.*\\.xlsx|.*\\.docx|.*\\.txt");
        ...
        tweet = tweet.replaceAll("#([a-zA-Z0-9_]{1,50})", "");
        ...
        // Provide the regex pattern
        tweet = tweet.replaceAll("((http:?)://)[a-zA-z0-9./]{4,}", "");
